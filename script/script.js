...
function updateTimer() {
    const targetDate = new Date("january 18, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '542914714456'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
    // Definir los números de teléfono
    const phoneNumber1 = '542914714456'; // Número para el primer botón
